...
[![Test](https://github.com/NpoolPlatform/commission-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/commission-manager/actions/workflows/main.yml)
...
* make commission-manager ```单独编译服务```
* make commission-manager-image ```单独生成服务镜像```
