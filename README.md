...
[![Test](https://github.com/NpoolPlatform/archivement-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/archivement-middleware/actions/workflows/main.yml)
...
* make archivement-middleware ```单独编译服务```
* make archivement-middleware-image ```单独生成服务镜像```
